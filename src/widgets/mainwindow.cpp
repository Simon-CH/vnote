...
void MainWindow::setupLocationList()
{
    ...
    connect(&VNoteX::getInst(), &VNoteX::addToLocationListRequested,
            m_locationList, &LocationList::addLocation);
    connect(&VNoteX::getInst(), &VNoteX::clearLocationListRequested,
            this, [this]() {
